...
@Component({
  selector: 'app-epicas-page',
  templateUrl: '../../products-page.component.html',
  styleUrls: ['../../products-page.component.css']
})

export class EpicasPageComponent  implements OnInit, AfterViewChecked {
  ...
  getCartasByPage(pageNumber: number): void {
    ...
    const apiUrl = `https://cards.thenexusbattles2.cloud/api/cartas/?size=6&page=${pageNumber}&coleccion=Epicas&onlyActives=true`;
