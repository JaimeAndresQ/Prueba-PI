...
@Component({
    selector: 'app-tipoF-page',
    templateUrl: '../../products-page.component.html',
    styleUrls: ['../../products-page.component.css']
})

export class FirePageComponent  implements OnInit, AfterViewChecked {
  ...
  //obtener las cartas de la API
    ...
    const apiUrl = `https://store.thenexusbattles2.cloud/cards/api/Fuego/`;
